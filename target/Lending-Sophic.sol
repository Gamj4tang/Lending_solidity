...
contract DreamAcademyLending {
    ...
    function borrow(address tokenAddress, uint256 amount) public {
        ...
        console.log("rentable: %s", rentable);
    ...
    function liquidate(address user, address tokenAddress, uint256 amount) public {
        ...
        console.log("amount: %s", amount);
        console.log("etherAmount: %s", _etherHolders[user]._etherAmount);
        console.log("borrowAmount: %s", _etherHolders[user]._borrowAmount);
        console.log("price: %s", _priceOracle.getPrice(tokenAddress));
        console.log("price: %s", _priceOracle.getPrice(address(0x0)));
